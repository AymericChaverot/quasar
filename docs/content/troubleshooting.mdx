...
Two places tell you what happened: the **audit log**, which records who did what and from where, and the application's **Logs** tab and its history. After that, open an issue on [GitHub](https://github.com/AymericChaverot/quasar/issues).
